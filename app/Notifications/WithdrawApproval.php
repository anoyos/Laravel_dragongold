...
class WithdrawApproval extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject('Withdrawal update on ' . config('app.name'))
                    ->greeting("Hello {$notifiable->username},")
                    ->line('Your recent withdrawal on ' . config('app.name') . ' require further approval by Administrator')
