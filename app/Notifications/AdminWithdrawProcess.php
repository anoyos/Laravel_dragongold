...
class AdminWithdrawProcess extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                        ...
                        ->line($this->user->name . ' have made a succussful withdrawal on ' . config('app.name'))
...
//                      ->action('View Transaction', route('admin.transactions'));
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'type' => 'withdraw',
            'message' => "Withdrawal of {$this->transaction->amount} {$this->currency} requested by {$this->user->name} processed"
        ];
    }
}
