                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="product-price">
                                        {{ $deposit->transaction->amount }} {{ $deposit->transaction->currency->symbol }}
                                    </td>
                                    <td class="product-price">
                                        {{ $deposit->assisted }} {{ $deposit->transaction->currency->symbol }}
                                    </td>
                                    <td>
                                        {{ $deposit->type }}
                                    </td>
                                    ...
                                    <td> <a href="{{ route('admin.deposits.detail', $deposit->transaction_id) }}" class="btn btn-icon btn-outline-info" data-toggle="tooltip" title="View"><i class="feather icon-eye"></i></a> </td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
