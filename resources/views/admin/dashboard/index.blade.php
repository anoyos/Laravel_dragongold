...
@section('mystyle')
<link rel="stylesheet" href="{{ asset('admin_assets/css/pages/dashboard-analytics.css') }}">
@endsection
...
<!-- Dashboard Analytics Start -->
            ...
            card-img-right">
                                        ...
                                        <div class="text-center">
                                            <h1 class="mb-2 text-white">Hello {{Auth::user()->name}},</h1>
                                            <p class="m-auto w-75">Welcome to Dragon Gold Admin Panel</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1 mb-25">@totalInvestors</h2>
                        ...
                        <div class="col-lg-3 col-md-3 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1 mb-25">@deals</h2>
                                    <p class="mb-0">Deposits made</p>
                                </div>
                                <div class="card-content">
                        ...
                        <div class="col-lg-3 col-md-3 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1 mb-25">@totalInvested</h2>
                        ...
                        <div class="col-lg-3 col-md-3 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1 mb-25">@totalPaid</h2>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="mb-0">Recent Registered Users</h4>
                                </div>
                                <div class="card-content">
                                        ...
                                        <table class="table table-hover-animation mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $user->name }}</td>
                                                    <td>{{ $user->email }}</td>
                                                    <td><i class="fa fa-circle font-small-3 text-{{ !is_null($user->email_verified_at) ? 'success' : 'danger' }} mr-50"></i>{{ !is_null($user->email_verified_at) ? 'Active' : 'Unverified' }}</td>
                                        ...
                                        <table class="table table-hover-animation mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><i class="fa fa-circle font-small-3 text-{{ $transaction->status == 'active' ? 'success' : 'warning' }} mr-50"></i>{{ $transaction->status }}</td>
